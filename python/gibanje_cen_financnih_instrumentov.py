...
def pridobljaj_cene(oznaka, perioda, izhod):
    while True:
        cas = podatek_o_casu()
        print("Ob trenutku {} shranjena cena.".format(cas))
        cena = pridobi_zadnjo_ceno(oznaka)
        with open(izhod, "a") as f:
            print("{} {}".format(cas, cena), file=f)
        time.sleep(perioda)        
