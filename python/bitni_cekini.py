...
class BitniCekin:
    def __init__(self, stanje=0):
        self.stanje = stanje
        print("Uspešno smo ustvarili nov bitni cekin!")
...
# naslov_1 = BitniCekin(1)
# naslov_1.dvig(0.5)     True
# print(naslov_1)        Št bitnih cekinov je: 0.5
# naslov_1.dvig(10)     False
...
def prenesi(racun1, racun2, koliko):
    if racun1.dvig(koliko): #uspešno izveden dvig
        racun2.polog(koliko)
        return True
    else: #neuspešno
        return False
...
def _validate_current_file():
    ...
    try:
        ...
        token = 'Token be86a15193cb68390766b9de3bc0d0c68fdc8c7d'
