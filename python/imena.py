...
def koliko(niz, datoteka):
    with open(datoteka, "w") as f:
        ...
        #najprej določimo vsa imena brez ponovitev
        brez_ponovitev = []
        for ime in vsa_imena:
            if ime not in brez_ponovitev: #imena še nismo videli
                brez_ponovitev.append(ime) #zato ga dodamo

        #zdaj pa ta imena zapisemo v datoteko
...
def koliko_iz_datoteke(vhodna, izhodna):
    ...
    with open(vhodna) as f:
        for vrstica in f:
            ...
            #dodamo imena v tej vrstici
            for ime in imena:
                vsa_imena.append(ime)

    #določimo vsa imena brez ponovitev
    brez_ponovitev = []
    for ime in vsa_imena:
        if ime not in brez_ponovitev: #imena še nismo videli
            brez_ponovitev.append(ime) #zato ga dodamo
